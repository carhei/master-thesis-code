...
\begin{algorithmic}
   ...
   \FORALL{$(s,a)$}
    ...
    \STATE $U(s,a) \leftarrow 0$   \qquad\qquad\qquad\qquad {\color{blue}  {\texttt{// per-batch cumulative $Q$-values for $(s,a)$}}} 
   ...
   \FOR{$t\geq 1$}   %\qquad\qquad\qquad\qquad {\color{blue}  {\texttt{// main loop}}}
    ...
    \IF{$L(s_t,a_t)$=\textsf{TRUE}} \alsp
        ...
        \IF{$C(s_t,a_t)=M(s_t,a_t)$} \alsp
            ...
            \STATE $\varepsilon \leftarrow \min \{1.1\varepsilon, \varepsilon_{\mathrm{target}}\}$ \alsp  \qquad\qquad\qquad\qquad {\color{blue}  {\texttt{// increase the threshold}}}
        \ENDIF
    \ENDIF
   \ENDFOR             
